...
This folder contains some basic ISO-8583 message payloads. They can be used to check if
the binary echo server is running and receives your messages in a proper way.

Some ISO-8583 hosts respond only to messages they understand. This is why one has to be
...
Important: note that field 12 must represent the current transaction date. The field
