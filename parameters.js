exports.params = {
  ...
  useStaticHeader:        {sample: '',                    type: 'h', title: 'Specify iso8583 static string header (will be prepended to length header if length header is enabled). Default format is hex, use "string:" prefix for string input', default: ""},
