exports.params = {
  ...
  testClients:            {sample: '<number>',            type: 'n',    title: 'Run the given number of test clients against the upstream'},
  ...
  c:                      {sample: '<config file path>', type: 's',    title: 'Read configuration from file'},
  ...
  useHeader:              {sample: '',                    type: 'b',    title: 'Disable or enable ISO 8583 header (currently supported only for upstream communication)', default: true},
  headerFormat:           {sample: '',                    type: 's',    title: 'ISO 8583 header format (every header field is comma-separated and defined as <name:type:length:default>)', default: 'length:n:4'},
