exports.params = {
  hostConfig:             {sample: '',                    type: 's',    title: 'Sets remote syntax configuration. Available templates: fis (default), smartVista, openWay. See iso8583/lib/packager', default: 'fis'},
  fis:                    {sample: '',                    type: 'b',    title: 'Follow FIS EBT ISO 8583 syntax',               replaced: 'system'},
  ...
  downstreamWebhookURL:   {sample: '<url>',               type: 's',    title: 'Downstream webhook URL to forward inbound requests'},
