  ...
  if (data) {
    ...
    if (typeof data == 'string' || typeof data == 'object' && data instanceof Buffer) {
      ...
      if (!options.hasOwnProperty('staticHeader') && !this.packager.config.validators.isValidMessage(data)) {
        ...
        return null;
      } else if (options.hasOwnProperty('staticHeader') && options.staticHeader && options.staticHeader.length && !Buffer.compare(data.slice(0, options.staticHeader.length), new Buffer(options.staticHeader))) {
